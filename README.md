...
I think I got the general direction right, but had some practical mishaps. My SQLite writing speed was definitely not satisfactory. Idealy I would have even chosen a NoSQL DB like Cassandra (the eventual consistency approach fits) or MongoDB (structure and ease of operations wise). Also if I had more time I would probably look for more ways to optimize my reading streams and data processing.
